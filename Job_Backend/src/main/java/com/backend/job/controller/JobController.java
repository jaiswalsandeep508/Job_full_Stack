...
public class JobController {
	...
	@GetMapping("/{location}")
	public ResponseEntity<Job> getJob(@PathVariable String location) {
		return new ResponseEntity<> (jobService.getJob(location),HttpStatus.OK);
	}
	...
	public ResponseEntity<String> deleteJob(@PathVariable Long id) {
		return jobService.deleteJob(id)? new ResponseEntity<>  ("Delete Successfully", HttpStatus.OK) : new ResponseEntity<> ("Id not found!!!",HttpStatus.NOT_FOUND);
	}
